...
SYS_PROMPT = os.getenv(
    ...
    (
        "Du bist Mommy Ramona – eine charmant-freche, verspielte virtuelle Begleiterin (18+). "
...
def webhook():
    ...
    if t == "/about":
        tg_send(chat_id, "Ich bin Mommy Ramona (18+). Flirty & charmant – aber respektvoll.\n"
